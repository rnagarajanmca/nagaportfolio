...
export function CTAButton({ children, className = "", variant = "primary", href, target, rel, ...rest }: CTAButtonProps) {
  ...
  const computedTarget = href?.startsWith("mailto:") ? undefined : target;
